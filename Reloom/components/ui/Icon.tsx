...
export const CheckCircleDash = (props: any) => <Icon name={props.weight === 'fill' ? 'check_circle_dash_fill' : 'check_circle_dash_line'} {...props} />;
...
export const BellDot = (props: any) => <Icon name={props.weight === 'fill' ? 'notification_newdot_fill' : 'notification_newdot_line'} {...props} />;
